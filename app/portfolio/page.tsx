                    ...
                    <div className="max-w-2xl mx-auto px-6 pt-32 pb-20">
                        <div className="mb-16">
                            ...
                            <div className="flex flex-wrap items-center gap-4 sm:gap-5 text-theme-muted">
                                <a href="https://github.com/ayushzjzjjjzk" target="_blank" rel="noopener noreferrer" className="hover:text-theme-icon-hover transition-colors" title="GitHub">
                        ...
                        <section className="mb-16">
                            ...
                            <GitHubContributions username="ayushzjzjjjzk" />
                        </section>
