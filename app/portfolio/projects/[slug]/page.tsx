...
export default function ProjectDetailPage({ params }: ProjectDetailPageProps) {
    ...
    const project = projects.find(
        (p) => p.id.toLowerCase().trim() === normalizedSlug || p.id.toLowerCase().replace(/_/g, '-') === normalizedSlug.replace(/_/g, '-')
    );
    ...
    const statusStyle = statusStyles[project.status] || statusStyles['Live'];
            ...
            <div className="min-h-screen text-page-text overflow-y-auto overflow-x-hidden relative z-2" style={geistMonoFont}>
                ...
                >
                    <div className="max-w-3xl mx-auto px-6 pt-32 pb-20">
                        ...
                        <div className="relative rounded-xl overflow-hidden border border-theme-divider mb-6 bg-theme-card aspect-video">
                            {project.videoUrl ? (
                                <video
                        ...
                        <div className="flex items-center justify-between mb-8 py-4 flex-wrap gap-4">
                            ...
                            {project.status === 'Live' && project.postUrl && (
                                <a
